<h2><a href="https://www.geeksforgeeks.org/problems/for-loop-1-1605617969/1?page=2&category=CPP&sortBy=submissions">For Loop - 1</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a number <strong>n</strong>, you need to print its multiplication table in a single line.</span></p>
