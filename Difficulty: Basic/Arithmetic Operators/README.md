<h2><a href="https://www.geeksforgeeks.org/problems/arithmetic-operators-1605594922/1?page=2&category=CPP&sortBy=submissions">Arithmetic Operators</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given two integer variables x and y. You need to perform the following operations:</span></p>
<ul>
