<h2><a href="https://www.geeksforgeeks.org/problems/find-if-ve-ve-or-0--141631/1?page=6&category=CPP&sortBy=submissions">Find if +ve, -ve or 0</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You will be given a number <strong>a. </strong>Your task is to print <strong>"Positive"</strong> if the number is positive, print <strong>"Negative"</strong> if negative and print <strong>"Zero"</strong> if it is 0 (without adding a line break statement).</span></p>
