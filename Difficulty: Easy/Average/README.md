<h2><a href="https://www.geeksforgeeks.org/problems/average-1608106189/1?page=6&category=CPP&sortBy=submissions">Average</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array&nbsp;<strong>arr </strong>that contains integers. You need to return the<strong> floor</strong> value of average of the <strong>non negative</strong> integers.</span></p>
